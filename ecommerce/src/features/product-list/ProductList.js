...
import valija from '../../assets/productos/valija.jpg'
import alcancia from '../../assets/productos/alcancia.jpg'
...
const filters = [
  ...
  },
  {
    ...
    name: 'Categoría',
    options: [
      { value: 'nuevos-ingresos', label: 'Nuevos Ingresos', checked: false },
      { value: 'libretas', label: 'Libretas', checked: true },
      { value: 'tazas', label: 'Tazas', checked: false },
